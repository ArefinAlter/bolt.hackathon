      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Everything you need to transform your return management process and deliver exceptional customer experiences.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-white shadow-md">
            ...
            <span className="text-sm font-medium text-gray-700">Enterprise-grade security and compliance</span>
          </div>
        </div>
      </div>
    </section>
