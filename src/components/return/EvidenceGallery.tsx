            ...
            {isImageUrl(url) ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-gray-100">
                <div className="text-center p-2">
                  <ImageIcon className="h-8 w-8 text-gray-900 dark:text-gray-100 mx-auto mb-1" />
                  <p className="text-xs text-gray-900 dark:text-gray-100 truncate">File {index + 1}</p>
                </div>
              </div>
            )}
          </div>
              ...
              {isImageUrl(evidenceUrls[selectedImageIndex]) ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gray-100">
                  <div className="text-center">
                    <ImageIcon className="h-16 w-16 text-gray-900 dark:text-gray-100 mx-auto mb-2" />
                    <p className="text-gray-900 dark:text-gray-100">Non-image file</p>
